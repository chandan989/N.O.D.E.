...
export const MarketOverview = ({ isExpandable, isExpanded, onToggleExpand }) => {
  return (
    <div className="pixel-card p-6 space-y-4">
      ...
      {isExpanded && (
        <div className="space-y-6 pt-4 border-t-2 border-dashed border-black/20">
          <MarketChart />
          <div className="flex justify-center space-x-4">
            <Button className="btn-pixel">Start Trading</Button>
            <Button variant="outline" className="btn-pixel">Learn More</Button>
          </div>
        </div>
      )}
